...
class Enemy {
    constructor(){
        ...
        this.angle = 0; // starting position along the path
        this.angleSpeed = Math.random() * 2 + 0.5; // speed
        this.curve = Math.random() * 200 + 50; // radius of the circle the characters are moving in
    }
    update(){
        // formula = movementRadiusX * anglePositionX + initialCoordinateX
        // play with the movement chaging the value that divides Math.PI. if value is equal for x and y movement is circle.
